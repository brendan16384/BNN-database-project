...
class Location(models.Model):
    ...
    loc_address = models.CharField(db_column='LOC_ADDRESS', max_length=45)  # Field name made lowercase.
...
class Product(models.Model):
    ...
    prod_sale_id = models.IntegerField(db_column='PROD_SALE_ID', blank=True, null=True)  # Field name made lowercase.
    sales_sale = models.ForeignKey('Sales', models.DO_NOTHING, db_column='SALES_SALE_ID')  # Field name made lowercase.
...
class SalesAtLocation(models.Model):
    sales_sale = models.OneToOneField(Sales, models.DO_NOTHING, db_column='SALES_SALE_ID', primary_key=True)  # Field name made lowercase.
    location_loc = models.ForeignKey(Location, models.DO_NOTHING, db_column='LOCATION_LOC_ID')  # Field name made lowercase.

    class Meta:
        managed = False
        db_table = 'sales_at_location'
        unique_together = (('sales_sale', 'location_loc'),)
